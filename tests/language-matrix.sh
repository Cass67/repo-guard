...
langs=(python go bash rust c swift javascript typescript ansible containers)
...
test_repo "all-langs" "python,go,bash,rust,c,swift,javascript,typescript,ansible,containers"
